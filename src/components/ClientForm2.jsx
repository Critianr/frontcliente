  ...
  return (
    <>
      <div>
        ...
        <p>Debe realizar una aplicación web que permita realizar las operaciones básicas (CRUD) sobre un cliente.</p>
        <p>Adicionalmente se debe crear una funcionalidad que después del registro almacene en base de datos si el cliente es viable, el criterio para determinar su viabilidad es que se encuentre en edad productiva (entre los 18 y 65 años)</p>
      </div>
      <form onSubmit={handleSubmit} className="needs-validation" noValidate>
        ...
        <button type="button" onClick={() => navigate('/lista')} className="btn btn-secondary ms-2">Ir a clientes</button>
